...
sample_data(ps0)$Timepoint[sample_data(ps0)$Timepoint=="4 mo interfacility/myco"] <- "4mpf"
sample_data(ps0)$Timepoint[sample_data(ps0)$Timepoint=="15 wpe M. chelonae/ 7 mo."] <- "7mpf"
...
levels(sample_data(ps1)$Timepoint) <- factor(levels(sample_data(ps1)$Timepoint), levels = c("4mpf", "7mpf"))
